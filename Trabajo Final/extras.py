...
def dibujar(screen, palabraUsuario, palabraActual, puntos, segundos):
    ...
    if(segundos<15):
        ...
        b=pygame.mixer.Sound("menosquince.wav")
        b.play()
    else:
...
##    #muestra su longitud
##    screen.blit(defaultFontGrande.render(str(len(palabraActual)), 1, (200,20,10)), (ANCHO//2-len(palabraActual)*TAMANNO_LETRA_GRANDE//4,ALTO-400))
